...
export default function VideoPlayer({ src, end, onMuteChange, setEnd }: VideoPlayerProps) {
    ...
    return (
        ...
        >
            ...
            <div
                className={`absolute bottom-0 left-0 right-0 bg-gradient-to-t from-black to-transparent p-4 transition-opacity duration-300 ${isControlsVisible ? "opacity-100" : "opacity-0"
                    }`}
            >
